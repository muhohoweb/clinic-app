...
class ScheduledReportController extends Controller
{
    ...
    {
        $schedules = ScheduledReport::orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $existingSchedule = ScheduledReport::where('email', $validated['email'])->first();

        $schedule = ScheduledReport::updateOrCreate(
